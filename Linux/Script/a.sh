...
atualizar_repositorio() {
    ...
    # Pergunta ao usuário se deseja enviar as atualizações para o GitHub
...
# Função para perguntar se deseja atualizar o GitHub e o site
atualizar_github_e_site() {
    # Pergunta se deseja enviar para o GitHub e atualizar o site
    read -p "Você quer atualizar o GitHub e o site? (sim/não): " resposta
    if [[ "$resposta" == "sim" ]]; then
        ...
        # Atualizar o site
        copiar_arquivos
        echo "O site foi atualizado com os arquivos do repositório!"
